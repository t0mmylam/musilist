...
const sequelize = new Sequelize(
  "postgres://musi:secret@postgres:5432/musilist",
  {
    dialect: "postgres",
    protocol: "postgres",
    dialectOptions: {},
...
app.post("/albums/update", async function (req, res) {
  ...
  if (album) {
    ...
    res.status(400).send("Error in updating album");
  }
});

app.post("/users/ratings/add", async function (req, res) {
  ...
  if (rating) {
    ...
    res.status(400).send("Error in adding new rating");
  }
});
